...
class FeatureGenerator(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = nn.Sequential(nn.Conv1d(1, 32, 15, 1, 7), nn.MaxPool1d(2, 2), nn.ReLU(), nn.BatchNorm1d(32))
...
def classifier():
    return nn.Sequential(nn.Linear(512, 100), nn.ReLU(), nn.Linear(100, 10))
